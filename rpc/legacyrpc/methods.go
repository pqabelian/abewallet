...
var rpcHandlers = map[string]struct {
	...
	"getbalances":      {handler: getBalances},
	...
	"listallutxo":           {handler: listAllUTXOAbe},
	"listimmaturetxo":       {handler: listUnmaturedUTXOAbe},
	"listmaturetxo":         {handler: listUnspentAbe},
	"listmaturecoinbasetxo": {handler: listUnspentCoinbaseAbe},
	"listunconfirmedtxo":    {handler: listSpentButUnminedAbe},
	"listconfirmedtxo":      {handler: listSpentAndMinedAbe},
	...
	"sendtoaddresses":          {handler: sendToAddressesAbe},
	"generateaddress":          {handler: generateAddressAbe},
