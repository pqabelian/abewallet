...
var (
	abecDefaultCAFile  = filepath.Join(abeutil.AppDataDir("abec", false), "rpc.cert")
	defaultAppDataDir  = abeutil.AppDataDir("abewallet", false)
...
type config struct {
	...
	AbecUsername     string                  `long:"btcdusername" description:"Username for btcd authentication"`
	AbecPassword     string                  `long:"btcdpassword" default-mask:"-" description:"Password for btcd authentication"`
...
func loadConfig() (*config, []string, error) {
	...
	//	todo(ABE.MUST): ABE does not support SPV or use neutrino in lighting
	if cfg.UseSPV {
